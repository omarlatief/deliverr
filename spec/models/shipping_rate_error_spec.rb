...
# Unit tests for DeliverrAPI::ShippingRateError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateError do
  let(:instance) { DeliverrAPI::ShippingRateError.new }

  describe 'test an instance of ShippingRateError' do
    it 'should create an instance of ShippingRateError' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateError)
    end
  end
end
