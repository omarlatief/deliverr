...
# Unit tests for DeliverrAPI::StatusCodesUNAUTHORIZED
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesUNAUTHORIZED do
  let(:instance) { DeliverrAPI::StatusCodesUNAUTHORIZED.new }

  describe 'test an instance of StatusCodesUNAUTHORIZED' do
    it 'should create an instance of StatusCodesUNAUTHORIZED' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesUNAUTHORIZED)
    end
  end
end
