...
# Unit tests for DeliverrAPI::BarcodeOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BarcodeOption do
  let(:instance) { DeliverrAPI::BarcodeOption.new }

  describe 'test an instance of BarcodeOption' do
    it 'should create an instance of BarcodeOption' do
      expect(instance).to be_instance_of(DeliverrAPI::BarcodeOption)
    end
  end
