...
# Unit tests for DeliverrAPI::ShippingPlanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanRequest do
  let(:instance) { DeliverrAPI::ShippingPlanRequest.new }

  describe 'test an instance of ShippingPlanRequest' do
    it 'should create an instance of ShippingPlanRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanRequest)
    end
  end
