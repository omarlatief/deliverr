...
# Unit tests for DeliverrAPI::ReturnStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnStatus do
  let(:instance) { DeliverrAPI::ReturnStatus.new }

  describe 'test an instance of ReturnStatus' do
    it 'should create an instance of ReturnStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnStatus)
    end
  end
end
