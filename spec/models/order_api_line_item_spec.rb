...
# Unit tests for DeliverrAPI::OrderApiLineItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiLineItem do
  let(:instance) { DeliverrAPI::OrderApiLineItem.new }

  describe 'test an instance of OrderApiLineItem' do
    it 'should create an instance of OrderApiLineItem' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiLineItem)
    end
  end
