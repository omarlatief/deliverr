...
# Unit tests for DeliverrAPI::StatusCodesCONFLICT
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesCONFLICT do
  let(:instance) { DeliverrAPI::StatusCodesCONFLICT.new }

  describe 'test an instance of StatusCodesCONFLICT' do
    it 'should create an instance of StatusCodesCONFLICT' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesCONFLICT)
    end
  end
end
