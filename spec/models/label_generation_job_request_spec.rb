...
# Unit tests for DeliverrAPI::LabelGenerationJobRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelGenerationJobRequest do
  let(:instance) { DeliverrAPI::LabelGenerationJobRequest.new }

  describe 'test an instance of LabelGenerationJobRequest' do
    it 'should create an instance of LabelGenerationJobRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelGenerationJobRequest)
    end
  end
