...
# Unit tests for DeliverrAPI::ApiProductModelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiProductModelResponse do
  let(:instance) { DeliverrAPI::ApiProductModelResponse.new }

  describe 'test an instance of ApiProductModelResponse' do
    it 'should create an instance of ApiProductModelResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiProductModelResponse)
    end
  end
