...
# Unit tests for DeliverrAPI::BoxLabelsFormat
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BoxLabelsFormat do
  let(:instance) { DeliverrAPI::BoxLabelsFormat.new }

  describe 'test an instance of BoxLabelsFormat' do
    it 'should create an instance of BoxLabelsFormat' do
      expect(instance).to be_instance_of(DeliverrAPI::BoxLabelsFormat)
    end
  end
end
