...
# Unit tests for DeliverrAPI::WeightUnit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WeightUnit do
  let(:instance) { DeliverrAPI::WeightUnit.new }

  describe 'test an instance of WeightUnit' do
    it 'should create an instance of WeightUnit' do
      expect(instance).to be_instance_of(DeliverrAPI::WeightUnit)
    end
  end
end
