...
# Unit tests for DeliverrAPI::ShippingRateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateResponse do
  let(:instance) { DeliverrAPI::ShippingRateResponse.new }

  describe 'test an instance of ShippingRateResponse' do
    it 'should create an instance of ShippingRateResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateResponse)
    end
  end
