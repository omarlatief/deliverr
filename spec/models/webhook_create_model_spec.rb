...
# Unit tests for DeliverrAPI::WebhookCreateModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookCreateModel do
  let(:instance) { DeliverrAPI::WebhookCreateModel.new }

  describe 'test an instance of WebhookCreateModel' do
    it 'should create an instance of WebhookCreateModel' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookCreateModel)
    end
  end
