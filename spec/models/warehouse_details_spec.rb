...
# Unit tests for DeliverrAPI::WarehouseDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WarehouseDetails do
  let(:instance) { DeliverrAPI::WarehouseDetails.new }

  describe 'test an instance of WarehouseDetails' do
    it 'should create an instance of WarehouseDetails' do
      expect(instance).to be_instance_of(DeliverrAPI::WarehouseDetails)
    end
  end
