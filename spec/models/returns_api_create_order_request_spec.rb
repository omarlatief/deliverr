...
# Unit tests for DeliverrAPI::ReturnsApiCreateOrderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiCreateOrderRequest do
  let(:instance) { DeliverrAPI::ReturnsApiCreateOrderRequest.new }

  describe 'test an instance of ReturnsApiCreateOrderRequest' do
    it 'should create an instance of ReturnsApiCreateOrderRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiCreateOrderRequest)
    end
  end
