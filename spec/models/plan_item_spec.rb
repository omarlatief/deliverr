...
# Unit tests for DeliverrAPI::PlanItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PlanItem do
  let(:instance) { DeliverrAPI::PlanItem.new }

  describe 'test an instance of PlanItem' do
    it 'should create an instance of PlanItem' do
      expect(instance).to be_instance_of(DeliverrAPI::PlanItem)
    end
  end
