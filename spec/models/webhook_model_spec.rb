...
# Unit tests for DeliverrAPI::WebhookModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookModel do
  let(:instance) { DeliverrAPI::WebhookModel.new }

  describe 'test an instance of WebhookModel' do
    it 'should create an instance of WebhookModel' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookModel)
    end
  end
