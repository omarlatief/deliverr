...
# Unit tests for DeliverrAPI::ParcelCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCreateRequest do
  let(:instance) { DeliverrAPI::ParcelCreateRequest.new }

  describe 'test an instance of ParcelCreateRequest' do
    it 'should create an instance of ParcelCreateRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCreateRequest)
    end
  end
