...
# Unit tests for DeliverrAPI::ReturnsSourceAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsSourceAddress do
  let(:instance) { DeliverrAPI::ReturnsSourceAddress.new }

  describe 'test an instance of ReturnsSourceAddress' do
    it 'should create an instance of ReturnsSourceAddress' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsSourceAddress)
    end
  end
