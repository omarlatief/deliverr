...
# Unit tests for DeliverrAPI::LotTrackingDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LotTrackingDetails do
  let(:instance) { DeliverrAPI::LotTrackingDetails.new }

  describe 'test an instance of LotTrackingDetails' do
    it 'should create an instance of LotTrackingDetails' do
      expect(instance).to be_instance_of(DeliverrAPI::LotTrackingDetails)
    end
  end
