...
# Unit tests for DeliverrAPI::ReturnsPublicApiMarketplace
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiMarketplace do
  let(:instance) { DeliverrAPI::ReturnsPublicApiMarketplace.new }

  describe 'test an instance of ReturnsPublicApiMarketplace' do
    it 'should create an instance of ReturnsPublicApiMarketplace' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiMarketplace)
    end
  end
end
