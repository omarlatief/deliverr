...
# Unit tests for DeliverrAPI::InventoryPool
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InventoryPool do
  let(:instance) { DeliverrAPI::InventoryPool.new }

  describe 'test an instance of InventoryPool' do
    it 'should create an instance of InventoryPool' do
      expect(instance).to be_instance_of(DeliverrAPI::InventoryPool)
    end
  end
end
