...
# Unit tests for DeliverrAPI::ReturnsApiProductDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiProductDetail do
  let(:instance) { DeliverrAPI::ReturnsApiProductDetail.new }

  describe 'test an instance of ReturnsApiProductDetail' do
    it 'should create an instance of ReturnsApiProductDetail' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiProductDetail)
    end
  end
