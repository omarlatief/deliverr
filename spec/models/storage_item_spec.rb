...
# Unit tests for DeliverrAPI::StorageItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StorageItem do
  let(:instance) { DeliverrAPI::StorageItem.new }

  describe 'test an instance of StorageItem' do
    it 'should create an instance of StorageItem' do
      expect(instance).to be_instance_of(DeliverrAPI::StorageItem)
    end
  end
