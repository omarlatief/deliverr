...
# Unit tests for DeliverrAPI::LengthUnit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LengthUnit do
  let(:instance) { DeliverrAPI::LengthUnit.new }

  describe 'test an instance of LengthUnit' do
    it 'should create an instance of LengthUnit' do
      expect(instance).to be_instance_of(DeliverrAPI::LengthUnit)
    end
  end
end
