...
# Unit tests for DeliverrAPI::UnprocessableEntityError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnprocessableEntityError do
  let(:instance) { DeliverrAPI::UnprocessableEntityError.new }

  describe 'test an instance of UnprocessableEntityError' do
    it 'should create an instance of UnprocessableEntityError' do
      expect(instance).to be_instance_of(DeliverrAPI::UnprocessableEntityError)
    end
  end
