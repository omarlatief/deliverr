...
# Unit tests for DeliverrAPI::OrderApiStatusModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiStatusModel do
  let(:instance) { DeliverrAPI::OrderApiStatusModel.new }

  describe 'test an instance of OrderApiStatusModel' do
    it 'should create an instance of OrderApiStatusModel' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiStatusModel)
    end
  end
