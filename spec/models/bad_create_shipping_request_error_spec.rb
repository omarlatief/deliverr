...
# Unit tests for DeliverrAPI::BadCreateShippingRequestError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadCreateShippingRequestError do
  let(:instance) { DeliverrAPI::BadCreateShippingRequestError.new }

  describe 'test an instance of BadCreateShippingRequestError' do
    it 'should create an instance of BadCreateShippingRequestError' do
      expect(instance).to be_instance_of(DeliverrAPI::BadCreateShippingRequestError)
    end
  end
