...
# Unit tests for DeliverrAPI::HazmatStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::HazmatStatus do
  let(:instance) { DeliverrAPI::HazmatStatus.new }

  describe 'test an instance of HazmatStatus' do
    it 'should create an instance of HazmatStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::HazmatStatus)
    end
  end
end
