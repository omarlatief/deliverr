...
# Unit tests for DeliverrAPI::LabelGenerationJobResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelGenerationJobResponse do
  let(:instance) { DeliverrAPI::LabelGenerationJobResponse.new }

  describe 'test an instance of LabelGenerationJobResponse' do
    it 'should create an instance of LabelGenerationJobResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelGenerationJobResponse)
    end
  end
