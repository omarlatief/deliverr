...
# Unit tests for DeliverrAPI::ParcelCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCreateResponse do
  let(:instance) { DeliverrAPI::ParcelCreateResponse.new }

  describe 'test an instance of ParcelCreateResponse' do
    it 'should create an instance of ParcelCreateResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCreateResponse)
    end
  end
