...
# Unit tests for DeliverrAPI::ReturnsDestinationAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsDestinationAddress do
  let(:instance) { DeliverrAPI::ReturnsDestinationAddress.new }

  describe 'test an instance of ReturnsDestinationAddress' do
    it 'should create an instance of ReturnsDestinationAddress' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsDestinationAddress)
    end
  end
