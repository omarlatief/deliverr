...
# Unit tests for DeliverrAPI::TrackingStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::TrackingStatus do
  let(:instance) { DeliverrAPI::TrackingStatus.new }

  describe 'test an instance of TrackingStatus' do
    it 'should create an instance of TrackingStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::TrackingStatus)
    end
  end
end
