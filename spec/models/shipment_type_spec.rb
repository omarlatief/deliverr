...
# Unit tests for DeliverrAPI::ShipmentType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShipmentType do
  let(:instance) { DeliverrAPI::ShipmentType.new }

  describe 'test an instance of ShipmentType' do
    it 'should create an instance of ShipmentType' do
      expect(instance).to be_instance_of(DeliverrAPI::ShipmentType)
    end
  end
end
