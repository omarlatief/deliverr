...
# Unit tests for DeliverrAPI::WebhookOrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookOrderStatus do
  let(:instance) { DeliverrAPI::WebhookOrderStatus.new }

  describe 'test an instance of WebhookOrderStatus' do
    it 'should create an instance of WebhookOrderStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookOrderStatus)
    end
  end
end
