...
# Unit tests for DeliverrAPI::BadParcelRequestError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadParcelRequestError do
  let(:instance) { DeliverrAPI::BadParcelRequestError.new }

  describe 'test an instance of BadParcelRequestError' do
    it 'should create an instance of BadParcelRequestError' do
      expect(instance).to be_instance_of(DeliverrAPI::BadParcelRequestError)
    end
  end
