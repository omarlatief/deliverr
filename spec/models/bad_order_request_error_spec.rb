...
# Unit tests for DeliverrAPI::BadOrderRequestError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadOrderRequestError do
  let(:instance) { DeliverrAPI::BadOrderRequestError.new }

  describe 'test an instance of BadOrderRequestError' do
    it 'should create an instance of BadOrderRequestError' do
      expect(instance).to be_instance_of(DeliverrAPI::BadOrderRequestError)
    end
  end
