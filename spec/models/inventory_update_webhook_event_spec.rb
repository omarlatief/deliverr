...
# Unit tests for DeliverrAPI::InventoryUpdateWebhookEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InventoryUpdateWebhookEvent do
  let(:instance) { DeliverrAPI::InventoryUpdateWebhookEvent.new }

  describe 'test an instance of InventoryUpdateWebhookEvent' do
    it 'should create an instance of InventoryUpdateWebhookEvent' do
      expect(instance).to be_instance_of(DeliverrAPI::InventoryUpdateWebhookEvent)
    end
  end
