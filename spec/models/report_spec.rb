...
# Unit tests for DeliverrAPI::Report
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::Report do
  let(:instance) { DeliverrAPI::Report.new }

  describe 'test an instance of Report' do
    it 'should create an instance of Report' do
      expect(instance).to be_instance_of(DeliverrAPI::Report)
    end
  end
