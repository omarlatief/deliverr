...
# Unit tests for DeliverrAPI::StatusCodesBADREQUEST
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesBADREQUEST do
  let(:instance) { DeliverrAPI::StatusCodesBADREQUEST.new }

  describe 'test an instance of StatusCodesBADREQUEST' do
    it 'should create an instance of StatusCodesBADREQUEST' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesBADREQUEST)
    end
  end
end
