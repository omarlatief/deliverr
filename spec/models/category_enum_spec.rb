...
# Unit tests for DeliverrAPI::CategoryEnum
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::CategoryEnum do
  let(:instance) { DeliverrAPI::CategoryEnum.new }

  describe 'test an instance of CategoryEnum' do
    it 'should create an instance of CategoryEnum' do
      expect(instance).to be_instance_of(DeliverrAPI::CategoryEnum)
    end
  end
end
