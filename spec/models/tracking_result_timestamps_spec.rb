...
# Unit tests for DeliverrAPI::TrackingResultTimestamps
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::TrackingResultTimestamps do
  let(:instance) { DeliverrAPI::TrackingResultTimestamps.new }

  describe 'test an instance of TrackingResultTimestamps' do
    it 'should create an instance of TrackingResultTimestamps' do
      expect(instance).to be_instance_of(DeliverrAPI::TrackingResultTimestamps)
    end
  end
