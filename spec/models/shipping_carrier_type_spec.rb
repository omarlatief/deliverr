...
# Unit tests for DeliverrAPI::ShippingCarrierType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingCarrierType do
  let(:instance) { DeliverrAPI::ShippingCarrierType.new }

  describe 'test an instance of ShippingCarrierType' do
    it 'should create an instance of ShippingCarrierType' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingCarrierType)
    end
  end
end
