...
# Unit tests for DeliverrAPI::MockWebhookDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::MockWebhookDetails do
  let(:instance) { DeliverrAPI::MockWebhookDetails.new }

  describe 'test an instance of MockWebhookDetails' do
    it 'should create an instance of MockWebhookDetails' do
      expect(instance).to be_instance_of(DeliverrAPI::MockWebhookDetails)
    end
  end
