...
# Unit tests for DeliverrAPI::ReturnsApiShippingLabel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiShippingLabel do
  let(:instance) { DeliverrAPI::ReturnsApiShippingLabel.new }

  describe 'test an instance of ReturnsApiShippingLabel' do
    it 'should create an instance of ReturnsApiShippingLabel' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiShippingLabel)
    end
  end
