...
# Unit tests for DeliverrAPI::ReturnsApiReturnItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiReturnItem do
  let(:instance) { DeliverrAPI::ReturnsApiReturnItem.new }

  describe 'test an instance of ReturnsApiReturnItem' do
    it 'should create an instance of ReturnsApiReturnItem' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiReturnItem)
    end
  end
