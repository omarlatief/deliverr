...
# Unit tests for DeliverrAPI::DeliverrAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::DeliverrAddress do
  let(:instance) { DeliverrAPI::DeliverrAddress.new }

  describe 'test an instance of DeliverrAddress' do
    it 'should create an instance of DeliverrAddress' do
      expect(instance).to be_instance_of(DeliverrAPI::DeliverrAddress)
    end
  end
