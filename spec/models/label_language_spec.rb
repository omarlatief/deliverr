...
# Unit tests for DeliverrAPI::LabelLanguage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::LabelLanguage do
  let(:instance) { DeliverrAPI::LabelLanguage.new }

  describe 'test an instance of LabelLanguage' do
    it 'should create an instance of LabelLanguage' do
      expect(instance).to be_instance_of(DeliverrAPI::LabelLanguage)
    end
  end
end
