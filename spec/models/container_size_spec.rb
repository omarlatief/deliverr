...
# Unit tests for DeliverrAPI::ContainerSize
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ContainerSize do
  let(:instance) { DeliverrAPI::ContainerSize.new }

  describe 'test an instance of ContainerSize' do
    it 'should create an instance of ContainerSize' do
      expect(instance).to be_instance_of(DeliverrAPI::ContainerSize)
    end
  end
end
