...
# Unit tests for DeliverrAPI::StatusCodesNOTFOUND
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesNOTFOUND do
  let(:instance) { DeliverrAPI::StatusCodesNOTFOUND.new }

  describe 'test an instance of StatusCodesNOTFOUND' do
    it 'should create an instance of StatusCodesNOTFOUND' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesNOTFOUND)
    end
  end
end
