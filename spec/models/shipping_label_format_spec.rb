...
# Unit tests for DeliverrAPI::ShippingLabelFormat
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingLabelFormat do
  let(:instance) { DeliverrAPI::ShippingLabelFormat.new }

  describe 'test an instance of ShippingLabelFormat' do
    it 'should create an instance of ShippingLabelFormat' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingLabelFormat)
    end
  end
end
