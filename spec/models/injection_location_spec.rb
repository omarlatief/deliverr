...
# Unit tests for DeliverrAPI::InjectionLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InjectionLocation do
  let(:instance) { DeliverrAPI::InjectionLocation.new }

  describe 'test an instance of InjectionLocation' do
    it 'should create an instance of InjectionLocation' do
      expect(instance).to be_instance_of(DeliverrAPI::InjectionLocation)
    end
  end
end
