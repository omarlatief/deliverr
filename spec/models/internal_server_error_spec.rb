...
# Unit tests for DeliverrAPI::InternalServerError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InternalServerError do
  let(:instance) { DeliverrAPI::InternalServerError.new }

  describe 'test an instance of InternalServerError' do
    it 'should create an instance of InternalServerError' do
      expect(instance).to be_instance_of(DeliverrAPI::InternalServerError)
    end
  end
