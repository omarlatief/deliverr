...
# Unit tests for DeliverrAPI::ApiProductModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiProductModel do
  let(:instance) { DeliverrAPI::ApiProductModel.new }

  describe 'test an instance of ApiProductModel' do
    it 'should create an instance of ApiProductModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiProductModel)
    end
  end
