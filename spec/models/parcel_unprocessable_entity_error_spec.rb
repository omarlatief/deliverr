...
# Unit tests for DeliverrAPI::ParcelUnprocessableEntityError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelUnprocessableEntityError do
  let(:instance) { DeliverrAPI::ParcelUnprocessableEntityError.new }

  describe 'test an instance of ParcelUnprocessableEntityError' do
    it 'should create an instance of ParcelUnprocessableEntityError' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelUnprocessableEntityError)
    end
  end
