...
# Unit tests for DeliverrAPI::Currency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::Currency do
  let(:instance) { DeliverrAPI::Currency.new }

  describe 'test an instance of Currency' do
    it 'should create an instance of Currency' do
      expect(instance).to be_instance_of(DeliverrAPI::Currency)
    end
  end
end
