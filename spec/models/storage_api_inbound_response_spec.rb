...
# Unit tests for DeliverrAPI::StorageApiInboundResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StorageApiInboundResponse do
  let(:instance) { DeliverrAPI::StorageApiInboundResponse.new }

  describe 'test an instance of StorageApiInboundResponse' do
    it 'should create an instance of StorageApiInboundResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::StorageApiInboundResponse)
    end
  end
