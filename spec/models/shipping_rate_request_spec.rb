...
# Unit tests for DeliverrAPI::ShippingRateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingRateRequest do
  let(:instance) { DeliverrAPI::ShippingRateRequest.new }

  describe 'test an instance of ShippingRateRequest' do
    it 'should create an instance of ShippingRateRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingRateRequest)
    end
  end
