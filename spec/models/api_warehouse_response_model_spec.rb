...
# Unit tests for DeliverrAPI::ApiWarehouseResponseModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiWarehouseResponseModel do
  let(:instance) { DeliverrAPI::ApiWarehouseResponseModel.new }

  describe 'test an instance of ApiWarehouseResponseModel' do
    it 'should create an instance of ApiWarehouseResponseModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiWarehouseResponseModel)
    end
  end
