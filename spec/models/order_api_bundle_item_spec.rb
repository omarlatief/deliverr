...
# Unit tests for DeliverrAPI::OrderApiBundleItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiBundleItem do
  let(:instance) { DeliverrAPI::OrderApiBundleItem.new }

  describe 'test an instance of OrderApiBundleItem' do
    it 'should create an instance of OrderApiBundleItem' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiBundleItem)
    end
  end
