...
# Unit tests for DeliverrAPI::WarehouseIdType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WarehouseIdType do
  let(:instance) { DeliverrAPI::WarehouseIdType.new }

  describe 'test an instance of WarehouseIdType' do
    it 'should create an instance of WarehouseIdType' do
      expect(instance).to be_instance_of(DeliverrAPI::WarehouseIdType)
    end
  end
end
