...
# Unit tests for DeliverrAPI::ServiceLevel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ServiceLevel do
  let(:instance) { DeliverrAPI::ServiceLevel.new }

  describe 'test an instance of ServiceLevel' do
    it 'should create an instance of ServiceLevel' do
      expect(instance).to be_instance_of(DeliverrAPI::ServiceLevel)
    end
  end
end
