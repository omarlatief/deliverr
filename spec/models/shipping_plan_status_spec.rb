...
# Unit tests for DeliverrAPI::ShippingPlanStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanStatus do
  let(:instance) { DeliverrAPI::ShippingPlanStatus.new }

  describe 'test an instance of ShippingPlanStatus' do
    it 'should create an instance of ShippingPlanStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanStatus)
    end
  end
end
