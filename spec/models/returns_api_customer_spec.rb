...
# Unit tests for DeliverrAPI::ReturnsApiCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiCustomer do
  let(:instance) { DeliverrAPI::ReturnsApiCustomer.new }

  describe 'test an instance of ReturnsApiCustomer' do
    it 'should create an instance of ReturnsApiCustomer' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiCustomer)
    end
  end
