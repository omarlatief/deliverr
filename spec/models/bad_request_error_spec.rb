...
# Unit tests for DeliverrAPI::BadRequestError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BadRequestError do
  let(:instance) { DeliverrAPI::BadRequestError.new }

  describe 'test an instance of BadRequestError' do
    it 'should create an instance of BadRequestError' do
      expect(instance).to be_instance_of(DeliverrAPI::BadRequestError)
    end
  end
