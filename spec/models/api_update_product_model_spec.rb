...
# Unit tests for DeliverrAPI::ApiUpdateProductModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiUpdateProductModel do
  let(:instance) { DeliverrAPI::ApiUpdateProductModel.new }

  describe 'test an instance of ApiUpdateProductModel' do
    it 'should create an instance of ApiUpdateProductModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiUpdateProductModel)
    end
  end
