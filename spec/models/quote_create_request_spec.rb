...
# Unit tests for DeliverrAPI::QuoteCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QuoteCreateRequest do
  let(:instance) { DeliverrAPI::QuoteCreateRequest.new }

  describe 'test an instance of QuoteCreateRequest' do
    it 'should create an instance of QuoteCreateRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::QuoteCreateRequest)
    end
  end
