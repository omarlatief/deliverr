...
# Unit tests for DeliverrAPI::UnId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnId do
  let(:instance) { DeliverrAPI::UnId.new }

  describe 'test an instance of UnId' do
    it 'should create an instance of UnId' do
      expect(instance).to be_instance_of(DeliverrAPI::UnId)
    end
  end
end
