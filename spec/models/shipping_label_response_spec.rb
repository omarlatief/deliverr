...
# Unit tests for DeliverrAPI::ShippingLabelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingLabelResponse do
  let(:instance) { DeliverrAPI::ShippingLabelResponse.new }

  describe 'test an instance of ShippingLabelResponse' do
    it 'should create an instance of ShippingLabelResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingLabelResponse)
    end
  end
