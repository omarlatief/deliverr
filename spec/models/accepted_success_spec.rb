...
# Unit tests for DeliverrAPI::AcceptedSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::AcceptedSuccess do
  let(:instance) { DeliverrAPI::AcceptedSuccess.new }

  describe 'test an instance of AcceptedSuccess' do
    it 'should create an instance of AcceptedSuccess' do
      expect(instance).to be_instance_of(DeliverrAPI::AcceptedSuccess)
    end
  end
