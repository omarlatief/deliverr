...
# Unit tests for DeliverrAPI::ParcelWeightUnit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelWeightUnit do
  let(:instance) { DeliverrAPI::ParcelWeightUnit.new }

  describe 'test an instance of ParcelWeightUnit' do
    it 'should create an instance of ParcelWeightUnit' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelWeightUnit)
    end
  end
end
