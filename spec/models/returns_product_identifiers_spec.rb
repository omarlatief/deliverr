...
# Unit tests for DeliverrAPI::ReturnsProductIdentifiers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsProductIdentifiers do
  let(:instance) { DeliverrAPI::ReturnsProductIdentifiers.new }

  describe 'test an instance of ReturnsProductIdentifiers' do
    it 'should create an instance of ReturnsProductIdentifiers' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsProductIdentifiers)
    end
  end
