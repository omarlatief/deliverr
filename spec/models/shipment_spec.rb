...
# Unit tests for DeliverrAPI::Shipment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::Shipment do
  let(:instance) { DeliverrAPI::Shipment.new }

  describe 'test an instance of Shipment' do
    it 'should create an instance of Shipment' do
      expect(instance).to be_instance_of(DeliverrAPI::Shipment)
    end
  end
