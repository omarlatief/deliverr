...
# Unit tests for DeliverrAPI::ReturnsApiInspectedReturnItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiInspectedReturnItem do
  let(:instance) { DeliverrAPI::ReturnsApiInspectedReturnItem.new }

  describe 'test an instance of ReturnsApiInspectedReturnItem' do
    it 'should create an instance of ReturnsApiInspectedReturnItem' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiInspectedReturnItem)
    end
  end
