...
# Unit tests for DeliverrAPI::UnauthorizedError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::UnauthorizedError do
  let(:instance) { DeliverrAPI::UnauthorizedError.new }

  describe 'test an instance of UnauthorizedError' do
    it 'should create an instance of UnauthorizedError' do
      expect(instance).to be_instance_of(DeliverrAPI::UnauthorizedError)
    end
  end
