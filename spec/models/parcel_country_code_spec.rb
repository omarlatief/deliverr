...
# Unit tests for DeliverrAPI::ParcelCountryCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelCountryCode do
  let(:instance) { DeliverrAPI::ParcelCountryCode.new }

  describe 'test an instance of ParcelCountryCode' do
    it 'should create an instance of ParcelCountryCode' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelCountryCode)
    end
  end
end
