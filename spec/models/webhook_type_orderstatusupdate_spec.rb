...
# Unit tests for DeliverrAPI::WebhookTypeORDERSTATUSUPDATE
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookTypeORDERSTATUSUPDATE do
  let(:instance) { DeliverrAPI::WebhookTypeORDERSTATUSUPDATE.new }

  describe 'test an instance of WebhookTypeORDERSTATUSUPDATE' do
    it 'should create an instance of WebhookTypeORDERSTATUSUPDATE' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookTypeORDERSTATUSUPDATE)
    end
  end
end
