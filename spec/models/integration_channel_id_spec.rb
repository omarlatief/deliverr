...
# Unit tests for DeliverrAPI::IntegrationChannelId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::IntegrationChannelId do
  let(:instance) { DeliverrAPI::IntegrationChannelId.new }

  describe 'test an instance of IntegrationChannelId' do
    it 'should create an instance of IntegrationChannelId' do
      expect(instance).to be_instance_of(DeliverrAPI::IntegrationChannelId)
    end
  end
end
