...
# Unit tests for DeliverrAPI::ProductCustomsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ProductCustomsInfo do
  let(:instance) { DeliverrAPI::ProductCustomsInfo.new }

  describe 'test an instance of ProductCustomsInfo' do
    it 'should create an instance of ProductCustomsInfo' do
      expect(instance).to be_instance_of(DeliverrAPI::ProductCustomsInfo)
    end
  end
