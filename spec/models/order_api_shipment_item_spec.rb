...
# Unit tests for DeliverrAPI::OrderApiShipmentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderApiShipmentItem do
  let(:instance) { DeliverrAPI::OrderApiShipmentItem.new }

  describe 'test an instance of OrderApiShipmentItem' do
    it 'should create an instance of OrderApiShipmentItem' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderApiShipmentItem)
    end
  end
