...
# Unit tests for DeliverrAPI::OrderShipmentObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderShipmentObject do
  let(:instance) { DeliverrAPI::OrderShipmentObject.new }

  describe 'test an instance of OrderShipmentObject' do
    it 'should create an instance of OrderShipmentObject' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderShipmentObject)
    end
  end
