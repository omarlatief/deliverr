...
# Unit tests for DeliverrAPI::Address
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::Address do
  let(:instance) { DeliverrAPI::Address.new }

  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(instance).to be_instance_of(DeliverrAPI::Address)
    end
  end
