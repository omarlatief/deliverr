...
# Unit tests for DeliverrAPI::ReturnsPublicApiCarriers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiCarriers do
  let(:instance) { DeliverrAPI::ReturnsPublicApiCarriers.new }

  describe 'test an instance of ReturnsPublicApiCarriers' do
    it 'should create an instance of ReturnsPublicApiCarriers' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiCarriers)
    end
  end
end
