...
# Unit tests for DeliverrAPI::ApiInboundShipmentStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiInboundShipmentStatus do
  let(:instance) { DeliverrAPI::ApiInboundShipmentStatus.new }

  describe 'test an instance of ApiInboundShipmentStatus' do
    it 'should create an instance of ApiInboundShipmentStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiInboundShipmentStatus)
    end
  end
end
