...
# Unit tests for DeliverrAPI::ShipmentItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShipmentItem do
  let(:instance) { DeliverrAPI::ShipmentItem.new }

  describe 'test an instance of ShipmentItem' do
    it 'should create an instance of ShipmentItem' do
      expect(instance).to be_instance_of(DeliverrAPI::ShipmentItem)
    end
  end
