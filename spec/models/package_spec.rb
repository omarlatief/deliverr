...
# Unit tests for DeliverrAPI::Package
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::Package do
  let(:instance) { DeliverrAPI::Package.new }

  describe 'test an instance of Package' do
    it 'should create an instance of Package' do
      expect(instance).to be_instance_of(DeliverrAPI::Package)
    end
  end
