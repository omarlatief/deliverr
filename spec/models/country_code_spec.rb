...
# Unit tests for DeliverrAPI::CountryCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::CountryCode do
  let(:instance) { DeliverrAPI::CountryCode.new }

  describe 'test an instance of CountryCode' do
    it 'should create an instance of CountryCode' do
      expect(instance).to be_instance_of(DeliverrAPI::CountryCode)
    end
  end
end
