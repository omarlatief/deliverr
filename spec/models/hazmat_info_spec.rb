...
# Unit tests for DeliverrAPI::HazmatInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::HazmatInfo do
  let(:instance) { DeliverrAPI::HazmatInfo.new }

  describe 'test an instance of HazmatInfo' do
    it 'should create an instance of HazmatInfo' do
      expect(instance).to be_instance_of(DeliverrAPI::HazmatInfo)
    end
  end
