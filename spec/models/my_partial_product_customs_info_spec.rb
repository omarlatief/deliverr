...
# Unit tests for DeliverrAPI::MyPartialProductCustomsInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::MyPartialProductCustomsInfo do
  let(:instance) { DeliverrAPI::MyPartialProductCustomsInfo.new }

  describe 'test an instance of MyPartialProductCustomsInfo' do
    it 'should create an instance of MyPartialProductCustomsInfo' do
      expect(instance).to be_instance_of(DeliverrAPI::MyPartialProductCustomsInfo)
    end
  end
