...
# Unit tests for DeliverrAPI::ForbiddenError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ForbiddenError do
  let(:instance) { DeliverrAPI::ForbiddenError.new }

  describe 'test an instance of ForbiddenError' do
    it 'should create an instance of ForbiddenError' do
      expect(instance).to be_instance_of(DeliverrAPI::ForbiddenError)
    end
  end
