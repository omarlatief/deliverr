...
# Unit tests for DeliverrAPI::ParcelAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelAddress do
  let(:instance) { DeliverrAPI::ParcelAddress.new }

  describe 'test an instance of ParcelAddress' do
    it 'should create an instance of ParcelAddress' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelAddress)
    end
  end
