...
# Unit tests for DeliverrAPI::WebhookTypeINVENTORYUPDATE
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookTypeINVENTORYUPDATE do
  let(:instance) { DeliverrAPI::WebhookTypeINVENTORYUPDATE.new }

  describe 'test an instance of WebhookTypeINVENTORYUPDATE' do
    it 'should create an instance of WebhookTypeINVENTORYUPDATE' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookTypeINVENTORYUPDATE)
    end
  end
end
