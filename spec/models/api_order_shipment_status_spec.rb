...
# Unit tests for DeliverrAPI::ApiOrderShipmentStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiOrderShipmentStatus do
  let(:instance) { DeliverrAPI::ApiOrderShipmentStatus.new }

  describe 'test an instance of ApiOrderShipmentStatus' do
    it 'should create an instance of ApiOrderShipmentStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiOrderShipmentStatus)
    end
  end
end
