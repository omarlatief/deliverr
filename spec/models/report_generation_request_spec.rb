...
# Unit tests for DeliverrAPI::ReportGenerationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportGenerationRequest do
  let(:instance) { DeliverrAPI::ReportGenerationRequest.new }

  describe 'test an instance of ReportGenerationRequest' do
    it 'should create an instance of ReportGenerationRequest' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportGenerationRequest)
    end
  end
