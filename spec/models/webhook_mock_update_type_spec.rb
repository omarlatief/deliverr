...
# Unit tests for DeliverrAPI::WebhookMockUpdateType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookMockUpdateType do
  let(:instance) { DeliverrAPI::WebhookMockUpdateType.new }

  describe 'test an instance of WebhookMockUpdateType' do
    it 'should create an instance of WebhookMockUpdateType' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookMockUpdateType)
    end
  end
end
