...
# Unit tests for DeliverrAPI::ShippingServiceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingServiceType do
  let(:instance) { DeliverrAPI::ShippingServiceType.new }

  describe 'test an instance of ShippingServiceType' do
    it 'should create an instance of ShippingServiceType' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingServiceType)
    end
  end
end
