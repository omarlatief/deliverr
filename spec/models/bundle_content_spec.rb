...
# Unit tests for DeliverrAPI::BundleContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BundleContent do
  let(:instance) { DeliverrAPI::BundleContent.new }

  describe 'test an instance of BundleContent' do
    it 'should create an instance of BundleContent' do
      expect(instance).to be_instance_of(DeliverrAPI::BundleContent)
    end
  end
