...
# Unit tests for DeliverrAPI::ApiBundleModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleModel do
  let(:instance) { DeliverrAPI::ApiBundleModel.new }

  describe 'test an instance of ApiBundleModel' do
    it 'should create an instance of ApiBundleModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleModel)
    end
  end
