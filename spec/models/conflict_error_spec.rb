...
# Unit tests for DeliverrAPI::ConflictError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ConflictError do
  let(:instance) { DeliverrAPI::ConflictError.new }

  describe 'test an instance of ConflictError' do
    it 'should create an instance of ConflictError' do
      expect(instance).to be_instance_of(DeliverrAPI::ConflictError)
    end
  end
