...
# Unit tests for DeliverrAPI::StatusCodesFORBIDDEN
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesFORBIDDEN do
  let(:instance) { DeliverrAPI::StatusCodesFORBIDDEN.new }

  describe 'test an instance of StatusCodesFORBIDDEN' do
    it 'should create an instance of StatusCodesFORBIDDEN' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesFORBIDDEN)
    end
  end
end
