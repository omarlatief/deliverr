...
# Unit tests for DeliverrAPI::QuoteCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QuoteCreateResponse do
  let(:instance) { DeliverrAPI::QuoteCreateResponse.new }

  describe 'test an instance of QuoteCreateResponse' do
    it 'should create an instance of QuoteCreateResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::QuoteCreateResponse)
    end
  end
