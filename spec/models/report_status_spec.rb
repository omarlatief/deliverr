...
# Unit tests for DeliverrAPI::ReportStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportStatus do
  let(:instance) { DeliverrAPI::ReportStatus.new }

  describe 'test an instance of ReportStatus' do
    it 'should create an instance of ReportStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportStatus)
    end
  end
end
