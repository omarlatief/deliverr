...
# Unit tests for DeliverrAPI::ReturnsApiInspectionDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiInspectionDetail do
  let(:instance) { DeliverrAPI::ReturnsApiInspectionDetail.new }

  describe 'test an instance of ReturnsApiInspectionDetail' do
    it 'should create an instance of ReturnsApiInspectionDetail' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiInspectionDetail)
    end
  end
