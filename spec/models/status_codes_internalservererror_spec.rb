...
# Unit tests for DeliverrAPI::StatusCodesINTERNALSERVERERROR
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesINTERNALSERVERERROR do
  let(:instance) { DeliverrAPI::StatusCodesINTERNALSERVERERROR.new }

  describe 'test an instance of StatusCodesINTERNALSERVERERROR' do
    it 'should create an instance of StatusCodesINTERNALSERVERERROR' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesINTERNALSERVERERROR)
    end
  end
end
