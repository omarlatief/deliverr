...
# Unit tests for DeliverrAPI::WebhookAuthType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookAuthType do
  let(:instance) { DeliverrAPI::WebhookAuthType.new }

  describe 'test an instance of WebhookAuthType' do
    it 'should create an instance of WebhookAuthType' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookAuthType)
    end
  end
end
