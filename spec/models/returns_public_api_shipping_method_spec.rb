...
# Unit tests for DeliverrAPI::ReturnsPublicApiShippingMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsPublicApiShippingMethod do
  let(:instance) { DeliverrAPI::ReturnsPublicApiShippingMethod.new }

  describe 'test an instance of ReturnsPublicApiShippingMethod' do
    it 'should create an instance of ReturnsPublicApiShippingMethod' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsPublicApiShippingMethod)
    end
  end
end
