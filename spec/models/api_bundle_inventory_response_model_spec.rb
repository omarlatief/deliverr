...
# Unit tests for DeliverrAPI::ApiBundleInventoryResponseModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleInventoryResponseModel do
  let(:instance) { DeliverrAPI::ApiBundleInventoryResponseModel.new }

  describe 'test an instance of ApiBundleInventoryResponseModel' do
    it 'should create an instance of ApiBundleInventoryResponseModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleInventoryResponseModel)
    end
  end
