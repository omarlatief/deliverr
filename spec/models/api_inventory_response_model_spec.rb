...
# Unit tests for DeliverrAPI::ApiInventoryResponseModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiInventoryResponseModel do
  let(:instance) { DeliverrAPI::ApiInventoryResponseModel.new }

  describe 'test an instance of ApiInventoryResponseModel' do
    it 'should create an instance of ApiInventoryResponseModel' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiInventoryResponseModel)
    end
  end
