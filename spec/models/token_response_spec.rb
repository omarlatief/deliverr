...
# Unit tests for DeliverrAPI::TokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::TokenResponse do
  let(:instance) { DeliverrAPI::TokenResponse.new }

  describe 'test an instance of TokenResponse' do
    it 'should create an instance of TokenResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::TokenResponse)
    end
  end
