...
# Unit tests for DeliverrAPI::QcItemStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::QcItemStatus do
  let(:instance) { DeliverrAPI::QcItemStatus.new }

  describe 'test an instance of QcItemStatus' do
    it 'should create an instance of QcItemStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::QcItemStatus)
    end
  end
end
