...
# Unit tests for DeliverrAPI::ExpiredTrackingData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ExpiredTrackingData do
  let(:instance) { DeliverrAPI::ExpiredTrackingData.new }

  describe 'test an instance of ExpiredTrackingData' do
    it 'should create an instance of ExpiredTrackingData' do
      expect(instance).to be_instance_of(DeliverrAPI::ExpiredTrackingData)
    end
  end
