...
# Unit tests for DeliverrAPI::ReturnsApiMarketplaceOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReturnsApiMarketplaceOrder do
  let(:instance) { DeliverrAPI::ReturnsApiMarketplaceOrder.new }

  describe 'test an instance of ReturnsApiMarketplaceOrder' do
    it 'should create an instance of ReturnsApiMarketplaceOrder' do
      expect(instance).to be_instance_of(DeliverrAPI::ReturnsApiMarketplaceOrder)
    end
  end
