...
# Unit tests for DeliverrAPI::ApiOrderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiOrderStatus do
  let(:instance) { DeliverrAPI::ApiOrderStatus.new }

  describe 'test an instance of ApiOrderStatus' do
    it 'should create an instance of ApiOrderStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiOrderStatus)
    end
  end
end
