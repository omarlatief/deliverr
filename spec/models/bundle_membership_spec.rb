...
# Unit tests for DeliverrAPI::BundleMembership
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::BundleMembership do
  let(:instance) { DeliverrAPI::BundleMembership.new }

  describe 'test an instance of BundleMembership' do
    it 'should create an instance of BundleMembership' do
      expect(instance).to be_instance_of(DeliverrAPI::BundleMembership)
    end
  end
