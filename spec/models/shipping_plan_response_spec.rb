...
# Unit tests for DeliverrAPI::ShippingPlanResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ShippingPlanResponse do
  let(:instance) { DeliverrAPI::ShippingPlanResponse.new }

  describe 'test an instance of ShippingPlanResponse' do
    it 'should create an instance of ShippingPlanResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ShippingPlanResponse)
    end
  end
