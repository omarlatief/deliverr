...
# Unit tests for DeliverrAPI::SellerReportType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::SellerReportType do
  let(:instance) { DeliverrAPI::SellerReportType.new }

  describe 'test an instance of SellerReportType' do
    it 'should create an instance of SellerReportType' do
      expect(instance).to be_instance_of(DeliverrAPI::SellerReportType)
    end
  end
end
