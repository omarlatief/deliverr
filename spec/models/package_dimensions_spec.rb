...
# Unit tests for DeliverrAPI::PackageDimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PackageDimensions do
  let(:instance) { DeliverrAPI::PackageDimensions.new }

  describe 'test an instance of PackageDimensions' do
    it 'should create an instance of PackageDimensions' do
      expect(instance).to be_instance_of(DeliverrAPI::PackageDimensions)
    end
  end
