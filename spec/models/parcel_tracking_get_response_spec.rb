...
# Unit tests for DeliverrAPI::ParcelTrackingGetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ParcelTrackingGetResponse do
  let(:instance) { DeliverrAPI::ParcelTrackingGetResponse.new }

  describe 'test an instance of ParcelTrackingGetResponse' do
    it 'should create an instance of ParcelTrackingGetResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ParcelTrackingGetResponse)
    end
  end
