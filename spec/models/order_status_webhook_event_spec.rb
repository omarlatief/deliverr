...
# Unit tests for DeliverrAPI::OrderStatusWebhookEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::OrderStatusWebhookEvent do
  let(:instance) { DeliverrAPI::OrderStatusWebhookEvent.new }

  describe 'test an instance of OrderStatusWebhookEvent' do
    it 'should create an instance of OrderStatusWebhookEvent' do
      expect(instance).to be_instance_of(DeliverrAPI::OrderStatusWebhookEvent)
    end
  end
