...
# Unit tests for DeliverrAPI::WebhookRequestMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookRequestMethod do
  let(:instance) { DeliverrAPI::WebhookRequestMethod.new }

  describe 'test an instance of WebhookRequestMethod' do
    it 'should create an instance of WebhookRequestMethod' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookRequestMethod)
    end
  end
end
