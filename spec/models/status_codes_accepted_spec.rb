...
# Unit tests for DeliverrAPI::StatusCodesACCEPTED
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesACCEPTED do
  let(:instance) { DeliverrAPI::StatusCodesACCEPTED.new }

  describe 'test an instance of StatusCodesACCEPTED' do
    it 'should create an instance of StatusCodesACCEPTED' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesACCEPTED)
    end
  end
end
