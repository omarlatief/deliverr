...
# Unit tests for DeliverrAPI::ReportGenerationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ReportGenerationResponse do
  let(:instance) { DeliverrAPI::ReportGenerationResponse.new }

  describe 'test an instance of ReportGenerationResponse' do
    it 'should create an instance of ReportGenerationResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ReportGenerationResponse)
    end
  end
