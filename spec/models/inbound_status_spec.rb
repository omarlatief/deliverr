...
# Unit tests for DeliverrAPI::InboundStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::InboundStatus do
  let(:instance) { DeliverrAPI::InboundStatus.new }

  describe 'test an instance of InboundStatus' do
    it 'should create an instance of InboundStatus' do
      expect(instance).to be_instance_of(DeliverrAPI::InboundStatus)
    end
  end
end
