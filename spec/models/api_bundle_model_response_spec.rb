...
# Unit tests for DeliverrAPI::ApiBundleModelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::ApiBundleModelResponse do
  let(:instance) { DeliverrAPI::ApiBundleModelResponse.new }

  describe 'test an instance of ApiBundleModelResponse' do
    it 'should create an instance of ApiBundleModelResponse' do
      expect(instance).to be_instance_of(DeliverrAPI::ApiBundleModelResponse)
    end
  end
