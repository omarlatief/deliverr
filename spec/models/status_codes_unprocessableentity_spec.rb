...
# Unit tests for DeliverrAPI::StatusCodesUNPROCESSABLEENTITY
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::StatusCodesUNPROCESSABLEENTITY do
  let(:instance) { DeliverrAPI::StatusCodesUNPROCESSABLEENTITY.new }

  describe 'test an instance of StatusCodesUNPROCESSABLEENTITY' do
    it 'should create an instance of StatusCodesUNPROCESSABLEENTITY' do
      expect(instance).to be_instance_of(DeliverrAPI::StatusCodesUNPROCESSABLEENTITY)
    end
  end
end
