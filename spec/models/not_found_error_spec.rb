...
# Unit tests for DeliverrAPI::NotFoundError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::NotFoundError do
  let(:instance) { DeliverrAPI::NotFoundError.new }

  describe 'test an instance of NotFoundError' do
    it 'should create an instance of NotFoundError' do
      expect(instance).to be_instance_of(DeliverrAPI::NotFoundError)
    end
  end
