...
# Unit tests for DeliverrAPI::WebhookType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::WebhookType do
  let(:instance) { DeliverrAPI::WebhookType.new }

  describe 'test an instance of WebhookType' do
    it 'should create an instance of WebhookType' do
      expect(instance).to be_instance_of(DeliverrAPI::WebhookType)
    end
  end
end
