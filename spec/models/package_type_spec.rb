...
# Unit tests for DeliverrAPI::PackageType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DeliverrAPI::PackageType do
  let(:instance) { DeliverrAPI::PackageType.new }

  describe 'test an instance of PackageType' do
    it 'should create an instance of PackageType' do
      expect(instance).to be_instance_of(DeliverrAPI::PackageType)
    end
  end
