...
# Unit tests for DeliverrAPI::ParcelIntegrationApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ParcelIntegrationApi' do
  before do
  ...
  describe 'test an instance of ParcelIntegrationApi' do
    it 'should create an instance of ParcelIntegrationApi' do
      expect(@api_instance).to be_instance_of(DeliverrAPI::ParcelIntegrationApi)
    end
  end
